...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#201C19] text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              <p>PH Plaza 2000, frente a Plaza New York / Av. Diagonal, 640, 6° A, Distrito de Les Corts, 08017 Barcelona, España</p>
              <p>Panamá</p>
              <p>Tel: +507 6917-7402 / +34 659 138005</p>
