...
export default function HeroSection({pageTitle} : {pageTitle: string}) {
    return(
        <section
            ...
            style={{ backgroundImage: "url('https://construccioneshitech.com/wp-content/uploads/2025/09/cuidad-panama-2-scaled.jpg')", backgroundPosition:"center center", backgroundSize:"cover" }} // coloca tu imagen en /public
        >
