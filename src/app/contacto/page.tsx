          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/2">
              <div className="bg-white rounded-xl shadow-md p-8 mb-8">
                <h2 className="text-2xl font-semibold mb-6 text-[#BE9A42]">Envíanos un mensaje</h2>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#BE9A42] focus:border-[#BE9A42] outline-none transition-colors"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    <button
                      ...
                      className="w-full bg-[#BE9A42] border hover:border-[#BE9A42] cursor-pointer text-white py-3 px-4 rounded-md hover:bg-white hover:text-[#BE9A42] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                    >
              ...
              <div className="bg-white rounded-xl shadow-md p-8 hidden md:block">
                <h2 className="text-2xl font-semibold mb-6 text-[#BE9A42]">Síguenos en redes sociales</h2>
            ...
            <div className="lg:w-1/2">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                <h2 className="text-2xl font-semibold mb-6 text-[#BE9A42] ">Información de contacto</h2>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-4">
                      <svg className="w-5 h-5 text-[#BE9A42]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">bakeralvarezcorporation@gmail.com</p>
                    </div>
                  </div>
